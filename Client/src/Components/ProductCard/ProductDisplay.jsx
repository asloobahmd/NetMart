        ...
        <div className="flex flex-wrap -mx-4">
          ...
          <div className="w-full md:w-1/2 px-4 mb-8">
            <img
              ...
              alt="Product"
              className="w-[600px] h-[400px] rounded-lg shadow-md mb-4"
              id="mainImage"
            />
          ...
          <div className="w-full md:w-1/2 px-4">
            ...
            <div className="mb-4">
              <span className="text-2xl font-bold mr-2">10,000 LKR</span>
              <span className="text-gray-500 line-through">14,000 LKR</span>
            </div>
            ...
            <div className="flex space-x-4 mb-6">
              <button className="bg-black flex gap-2 items-center text-white px-6 py-2 rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
